    ...
    return (
        <div className="text-white d-flex flex-column align-items-end w-100 border-bottom pb-3 mb-2">
            <div className="d-flex flex-column align-items-end mb-3">
                ...
                <p className=" text-end me-1 fw-200">{props.question}</p>
            ...
            <div>
                <div className="d-flex align-items-center mb-1 flex-row-reverse">
                    ...
                    <label className="fw-200 me-1 cur-poin fs-13 fs-sm-15" htmlFor={`option1${props.number}`}>{props.option1}</label>
                </div>
                <div className="d-flex align-items-center mb-1 flex-row-reverse">
                    <input className="cur-poin" onChange={changeHandler} type="radio" value={2} id={`option2${props.number}`}  name={`option${props.number}`}/>
                    <label className="fw-200 me-1 cur-poin fs-13 fs-sm-15" htmlFor={`option2${props.number}`}>{props.option2}</label>
                </div>
                <div className="d-flex align-items-center mb-1 flex-row-reverse">
                    <input className="cur-poin" onChange={changeHandler} type="radio" id={`option3${props.number}`} value={3} name={`option${props.number}`} />
                    <label className="fw-200 me-1 cur-poin fs-13 fs-sm-15" htmlFor={`option3${props.number}`}>{props.option3}</label>
                </div>
                <div className="d-flex align-items-center flex-row-reverse">
                    ...
                    <label className="fw-200 me-1 cur-poin fs-13 fs-sm-15" htmlFor={`option4${props.number}`}>{props.option4}</label>
                </div>
            </div>
        </div>
    );
