    ...
    return (
        <div className="d-flex flex-column align-items-center text-light w-100 mt-3">
            ...
            <div style={{flexWrap:"wrap"}} className="text-center fs-15 w-100 d-flex flex-row-reverse justify-content-center align-items-center">
                <p style={{width:"250px"}} className="py-1 mx-1 mx-sm-2 px-3 rounded bg-light text-dark"> {questions.length} : تعداد کل سوالات</p>
                <p style={{width:"250px"}} className="py-1 mx-1 mx-sm-2 px-3 rounded bg-success">{corrects.length} : تعداد پاسخ های درست</p>
                <p style={{width:"250px"}} className="py-1 mx-1 mx-sm-2 px-3 rounded bg-danger">{incorrects.length} : تعداد پاسخ های نادرست</p>
                <p style={{width:"250px"}} className="py-1 mx-1 mx-sm-2 px-3 rounded bg-warning text-main-1">{noAnswers.length} : تعداد سوالات بدون پاسخ</p>
                <p style={{width:"250px"}} className="py-1 mx-1 mx-sm-2 px-3 rounded bg-main-1"> وضعیت  : {corrects.length < 26 ? "مردود" : "قبول"}</p>
            </div>
